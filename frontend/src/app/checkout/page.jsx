...
//   // Validate field when it's touched and changed
...
//                     if (touched.timeSlot) {
//                       const error = validateField("timeSlot", value);
//                       setErrors((prev) => ({
//                         ...prev,
//                         timeSlot: error,
//                       }));
...
//                   </SelectTrigger>
//                   <SelectContent
//                     className="min-w-[var(--radix-select-trigger-width)] bg-white rounded-md shadow-lg border border-gray-200"
//                     position="popper"
//                     align="end"
//                     sideOffset={5}
//                   >
...
//                 onClick={handleOrder}
//                 disabled={cart.products.length === 0}
//                 className="w-full bg-cartBackgroundColor text-white"
//                 size="lg"
//               >
//                 Place Order
//               </Button>
