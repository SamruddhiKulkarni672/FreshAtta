export async function POST(req) {
  try {
    ...
    const res = await fetch("http://192.168.1.39:8080/admin/product-manage/custom-variant", {
      method: "POST",
...
export async function GET(req) {
  try {
    ...
    const res = await fetch(`http://192.168.1.39:8080/admin/product-manage/custom-variant?productId=${productId}`);
...
export async function DELETE(request) {
  ...
  const res = await fetch(`http://192.168.1.39:8080/admin/product-manage/custom-variant/${id}`, {
    method: "DELETE",
  });
